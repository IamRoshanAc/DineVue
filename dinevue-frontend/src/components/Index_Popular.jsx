...
const IndexPopularSlider = () => {
  ...
  return (
    <div className="slider-wrapper">
      <p className="fs-1">Popular</p>
      <div className="card-slider-container">
        <div className="card-slider">
          {restaurants.map((restaurant) => (
            <Link to={`/index_restaurant_view/${restaurant.id}`} className="card" key={restaurant.id}>
              <img
...
export default IndexPopularSlider;
